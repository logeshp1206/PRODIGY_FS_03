...
import { Search, ArrowRight, SlidersHorizontal, ArrowUpDown, Sprout, Star, ShoppingCart } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
          ...
          <div className="container mx-auto px-4 relative z-10 text-white">
            <div className="max-w-2xl space-y-6 animate-in slide-in-from-left duration-700 fade-in">
              ...
              <p className="text-lg md:text-xl text-white/90 max-w-lg leading-relaxed">
                Support your local community by shopping from independent artisans, bakers, and farmers. Delivered straight to your door.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Button size="lg" className="rounded-full h-12 px-8 text-lg bg-primary hover:bg-primary/90 text-white border-none">
                  Shop Now
                </Button>
                <Button size="lg" variant="outline" className="rounded-full h-12 px-8 text-lg bg-white/10 backdrop-blur-sm border-white/30 text-white hover:bg-white/20">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <div className="flex items-center gap-2 overflow-x-auto w-full md:w-auto pb-2 md:pb-0 no-scrollbar">
                <div className="flex items-center gap-2 pr-4 border-r border-border mr-2">
                   ...
                   <span className="font-medium text-sm text-muted-foreground hidden sm:inline">Filter:</span>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
              <div className="space-y-4">
                ...
                <p className="text-white/80 leading-relaxed">
                  Every product is sourced from within 50 miles of our store, supporting our local economy.
                </p>
              </div>
              <div className="space-y-4">
                <div className="bg-white/10 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 backdrop-blur-sm">
                  <Badge className="w-8 h-8 bg-transparent" /> {/* Using Badge as icon placeholder */}
                  <Star className="w-8 h-8" />
                </div>
                <h3 className="font-heading text-2xl font-bold">Artisan Quality</h3>
                <p className="text-white/80 leading-relaxed">
                  Hand-picked goods that meet our strict standards for quality, sustainability, and craftsmanship.
                </p>
              </div>
              <div className="space-y-4">
                <div className="bg-white/10 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 backdrop-blur-sm">
                ...
                <h3 className="font-heading text-2xl font-bold">Same-Day Delivery</h3>
                <p className="text-white/80 leading-relaxed">
                  Order by 2pm and receive your goods the same evening. Freshness guaranteed.
                </p>
              </div>
            </div>
          </div>
